...
methods achieve higher mean EIG estimates than the three
...
IEEE14 systems at equal probe budgets. We report EIG estimates, seed variability, and offline and online computation. Our
...
We report this bound estimate as estimated EIG, rather than exact EIG. Individual scores can be negative but
...
Our implementation optimizes the ordered sequence using estimated EIG for the full sequence.
...
stage bias and a sigmoid action map. Offline training maximizes estimated
EIG by differentiating through the complete simulated sequence,
...
Tables~\ref{tab:ieee9} and~\ref{tab:ieee14} report EIG estimates in
...
\begin{table}[!ht]\caption{IEEE9 EIG estimates}\label{tab:ieee9}\papertablestyle
...
For IEEE14, Table~\ref{tab:ieee14} shows higher mean EIG estimates for
...
Step-DAD achieve higher mean EIG estimates than Random, Fixed and Myopic at
...
differs from the grid EIG estimator.
