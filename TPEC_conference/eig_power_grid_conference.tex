...
% Full project reference: ../documents/objective_driven_boed_manuscript_framework.tex.
...
% Compile from TPEC_conference; the bibliography is shared with documents/.
...
\bibliography{../documents/objective_driven_boed_refs}
\end{document}
