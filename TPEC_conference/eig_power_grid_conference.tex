...
order. These requirements motivate comparing policies that plan over all design steps with
...
improve information over Fixed and Random; whether policies that plan over all design steps
...
We compare all six methods using $T=3,4,5$ sequential design steps on
IEEE9 and IEEE14. Each design step selects a probe duration, applies the
probe, and collects one observation. Methods are compared at the same
number of design steps to assess how much information they acquire under
an equal probe budget. Both systems use the same sensor and feasible
design rule, with separate physical configurations and learned policies.
...
IEEE9 and IEEE14 panels; logarithmic time axis; all six methods and $T=3,4,5$.}
