...
myopic optimization of only the next probe.

\begin{table}[t]
\caption{Design-method comparison. Adaptive means using observed responses;
myopic means optimizing only the next probe. Fixed optimizes the full
sequence; Random has no information objective (N/A).}
\label{tab:methods}\papertablestyle
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}}lccc@{}}
\toprule Method & Adaptive & Myopic & Optimization\\\midrule
Random & No & N/A & None\\
Fixed~\cite{foster2021dad} & No & No & Offline\\
Myopic~\cite{foster2021dad} & Yes & Yes & Online\\
...
before observations are collected~\cite[Sec.~2]{foster2021dad}.
...
posterior~\cite[Sec.~2.1]{foster2021dad}. Our implementation maintains
