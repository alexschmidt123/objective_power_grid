...
Section~\ref{sec:cost}. IEEE14 timings use a Grace A100. IEEE9 uses an RTX 5080,
...
Figure~\ref{fig:tradeoff} separates information gain and computation
at $T=3$, using the same method order in every panel. Tables give the
complete $T=3,4,5$ results. Reading the two rows together shows the
small information differences between DAD and Step-DAD alongside their
large difference in online cost.
\begin{figure*}[t]
\centering
\begin{minipage}{0.49\textwidth}
\centering
\begin{tikzpicture}
\begin{axis}[width=0.95\linewidth,height=1.85in,
title={IEEE9 (RTX 5080)},xlabel={Information score (nats): higher is better},
ymin=-0.6,ymax=5.6,y dir=reverse,ytick={0,1,2,3,4,5},
yticklabels={Random,Fixed,Myopic,DAD,RL-sBOED,Step-DAD},
tick label style={font=\footnotesize},label style={font=\footnotesize},
title style={font=\small},xmajorgrids,grid style={gray!20},
clip=false,xmin=0,xmax=6.0,xtick={0,1,2,3,4,5}]
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(0.43214422,0) +- (0.03096603,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.43214422,0) {0.432};
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(2.01122652,1) +- (0.01164503,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:2.01122652,1) {2.011};
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(1.97360205,2) +- (0.0438258,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:1.97360205,2) {1.974};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(2.13656963,3) +- (0.01614446,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:2.13656963,3) {2.137};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(2.12573521,4) +- (0.00273759,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:2.12573521,4) {2.126};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(2.1471126,5) +- (0.01095406,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:2.1471126,5) {2.147};
\end{axis}
\end{tikzpicture}
\end{minipage}
\hfill
...
\begin{tikzpicture}
\begin{axis}[width=0.95\linewidth,height=1.85in,
title={IEEE14 (Grace A100)},xlabel={Information score (nats): higher is better},
ymin=-0.6,ymax=5.6,y dir=reverse,ytick={0,1,2,3,4,5},
yticklabels={Random,Fixed,Myopic,DAD,RL-sBOED,Step-DAD},
tick label style={font=\footnotesize},label style={font=\footnotesize},
title style={font=\small},xmajorgrids,grid style={gray!20},
clip=false,xmin=0,xmax=6.0,xtick={0,1,2,3,4,5}]
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(0.75408529,0) +- (0.00466976,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.75408529,0) {0.754};
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(4.2622935,1) +- (0.04016309,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:4.2622935,1) {4.262};
\addplot[only marks,blue!65!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(4.29074713,2) +- (0.0368272,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:4.29074713,2) {4.291};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(4.75757614,3) +- (0.03619873,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:4.75757614,3) {4.758};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(4.74454216,4) +- (0.00223913,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:4.74454216,4) {4.745};
\addplot[only marks,red!70!black,mark=*,mark options={solid},mark size=2.2pt,error bars/.cd,x dir=both,x explicit] coordinates {(4.75270046,5) +- (0.02745488,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:4.75270046,5) {4.753};
\end{axis}
\end{tikzpicture}
\end{minipage}
\par\medskip
...
\begin{tikzpicture}
\begin{axis}[width=0.95\linewidth,height=1.85in,
title={IEEE9 (RTX 5080)},xlabel={Online time (s/sequence): lower is better},
ymin=-0.6,ymax=5.6,y dir=reverse,ytick={0,1,2,3,4,5},
yticklabels={Random,Fixed,Myopic,DAD,RL-sBOED,Step-DAD},
tick label style={font=\footnotesize},label style={font=\footnotesize},
title style={font=\small},xmajorgrids,grid style={gray!20},
clip=false,xmode=log,xmin=0.00004,xmax=200,xtick={0.0001,0.001,0.01,0.1,1,10},xticklabels={0.0001,0.001,0.01,0.1,1,10}]
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(7.145e-05,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:7.145e-05,0) {0.07 ms};
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00052316,1)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00052316,1) {0.52 ms};
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(9.30816641,2)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:9.30816641,2) {9.31 s};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00053701,3)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00053701,3) {0.54 ms};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00049159,4)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00049159,4) {0.49 ms};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(6.3424741,5)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:6.3424741,5) {6.34 s};
\end{axis}
\end{tikzpicture}
\end{minipage}
\hfill
...
\begin{tikzpicture}
\begin{axis}[width=0.95\linewidth,height=1.85in,
title={IEEE14 (Grace A100)},xlabel={Online time (s/sequence): lower is better},
ymin=-0.6,ymax=5.6,y dir=reverse,ytick={0,1,2,3,4,5},
yticklabels={Random,Fixed,Myopic,DAD,RL-sBOED,Step-DAD},
tick label style={font=\footnotesize},label style={font=\footnotesize},
title style={font=\small},xmajorgrids,grid style={gray!20},
clip=false,xmode=log,xmin=0.00004,xmax=200,xtick={0.0001,0.001,0.01,0.1,1,10},xticklabels={0.0001,0.001,0.01,0.1,1,10}]
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00016082,0)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00016082,0) {0.16 ms};
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.0011626,1)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.0011626,1) {1.16 ms};
\addplot[only marks,blue!65!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(9.99967671,2)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:9.99967671,2) {10.00 s};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00122492,3)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00122492,3) {1.22 ms};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(0.00168412,4)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:0.00168412,4) {1.68 ms};
\addplot[only marks,red!70!black,mark=square*,mark options={solid},mark size=2.2pt] coordinates {(9.11275457,5)};
\node[anchor=west,font=\scriptsize,xshift=5pt] at (axis cs:9.11275457,5) {9.11 s};
\end{axis}
\end{tikzpicture}
\end{minipage}
\par\medskip
\caption{Six-method comparison at three design steps. Top: mean terminal
sPCE with sample-SD bars (some are smaller than the markers); uncertainty
definitions follow Tables~\ref{tab:ieee9} and~\ref{tab:ieee14}.
Bottom: mean online computation, shown on a logarithmic axis and labeled
in milliseconds or seconds. Method names are repeated for direct lookup;
compare runtime within each system, since the hardware differs.}
\label{fig:tradeoff}
\end{figure*}
