...
Computation is reported in Section~\ref{sec:cost}. IEEE9 training seed
101 uses an A100; seeds 202/303 and current online timings use an RTX
5080. IEEE14 uses A100s. We keep these timing groups separate.
...
\begin{tikzpicture}\begin{axis}[width=\linewidth,height=1.75in,
title={(a) IEEE9: training seed 101},title style={font=\small},
...
\addplot[blue!75!black,mark=o,mark size=3.4pt,thick,dashed] coordinates {(3,0.55417601) (4,0.80200089) (5,1.06261734)};
\addlegendentry{Fixed}
\addplot[red!75!black,mark=square*,mark size=2.4pt,thick] coordinates {(3,0.56186976) (4,0.80561770) (5,1.07650202)};
\addlegendentry{DAD}
\addplot[teal!80!black,mark=triangle*,mark size=2.4pt,thick] coordinates {(3,0.10000015) (4,0.11689896) (5,0.12863530)};
\addlegendentry{RL-sBOED}
\end{axis}\end{tikzpicture}\end{minipage}
\hfill
\begin{minipage}{0.325\textwidth}\centering
\begin{tikzpicture}\begin{axis}[width=\linewidth,height=1.75in,
title={(b) IEEE9: seeds 202/303},title style={font=\small},
xlabel={Number of design steps $T$},ylabel={Offline training (h)},
xmin=2.8,xmax=5.2,xtick={3,4,5},ymin=0,ymax=4,ytick={0,1,2,3,4},
tick label style={font=\footnotesize},label style={font=\footnotesize},
grid=major,grid style={gray!20},legend columns=3,
legend style={font=\footnotesize},]
\addplot[blue!75!black,mark=o,mark size=3.4pt,thick,dashed] coordinates {(3,1.16355727) (4,1.69321612) (5,2.20963435)};
\addplot[red!75!black,mark=square*,mark size=2.4pt,thick] coordinates {(3,1.15386932) (4,1.68613556) (5,2.20822377)};
\addplot[teal!80!black,mark=triangle*,mark size=2.4pt,thick] coordinates {(3,0.13027744) (4,0.16881989) (5,0.20627866)};
\end{axis}\end{tikzpicture}\end{minipage}
\hfill
\begin{minipage}{0.325\textwidth}\centering
\begin{tikzpicture}\begin{axis}[width=\linewidth,height=1.75in,
title={(c) IEEE14: three training seeds},title style={font=\small},
xlabel={Number of design steps $T$},ylabel={Offline training (h)},
xmin=2.8,xmax=5.2,xtick={3,4,5},ymin=0,ymax=4,ytick={0,1,2,3,4},
tick label style={font=\footnotesize},label style={font=\footnotesize},
grid=major,grid style={gray!20},legend columns=3,
...
\caption{Offline training cost at $T=3,4,5$. Panel (a) reports IEEE9 seed 101; (b) averages seeds 202/303;
(c) averages three IEEE14 training seeds. Lines show recorded stage-time
means, not confidence intervals. Random/Myopic require no offline training;
Step-DAD reuses DAD. DAD stage time excludes the preceding Fixed training:
...
from online computation across all three design-step counts. IEEE9
training times are split by hardware rather than pooled across hosts.
