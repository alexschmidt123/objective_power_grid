...
Section~\ref{sec:system-model} defines the network representation, swing
dynamics and uncertain parameters. Section~\ref{sec:design-problem} formulates
the sequential probes, observation model and design objectives.
Section~\ref{sec:methodology} presents the solution methods, followed by the
experimental protocol in Section~\ref{sec:experimental-protocol}.
Section~\ref{sec:results} organizes the numerical comparisons and their
interpretation, and Section~\ref{sec:conclusion} concludes the paper.
...
\section{Sequential Experimental Design Problem}
...
\subsection{Motivation for Decision-Oriented Objectives}
...
% Add a concise quantitative conclusion only after the Results and Discussion section is populated.
