...
values. Do not construct a joint numerical ranking by mixing nats, control
magnitudes and loss values. Likewise, the scalar probing observation must not
...
Check finite objective values, duration bounds and ordering, common physical
and observation settings, and the provenance of the numerical implementation.
Preserve failure records and report missing cells rather than removing failed
systems or substituting results from a different protocol. Training and
...
% Complete after the numerical study: summarize the supported findings,
% their scope, principal limitations and a focused future direction.
