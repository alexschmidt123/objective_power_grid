...
- **system:** `ieee9`
- **data_dir:** `/home/grads/g/g.lin/Documents/dad_mocu_kuramoto_v4/data/ieee9_probe_amplitude_sweep/amp_0p025/probe`
- **N_obs / sigma:** `5` / `0.01`
...
- myopic_first=`0` {'bus': 0, 'amp': 0.025, 'duration': 0.5}
- planning_first=`10` {'bus': 1, 'amp': 0.025, 'duration': 1.0}
- fixed_pair=`[0, 45]`, ξ1 in fixed=`True`
- ξ1 mean |corr| with others=`0.9243196905316763`
...
- J_planning=0.399089
- J_fixed≈0.398333
- planning−myopic=-0.000182
- planning−fixed=0.000755
- distinct second actions=3, entropy=1.064
- mode ξ2 prob=0.4583333333333333, eff_n=2.796116504854369
- mean_branch_value=0.0

## Multi-T adaptive room (gap = J_plan − J_fixed)

- gaps=`{'2': 0.0012500000000000289, '3': 0.0004166666666666763, '4': 0.0004166666666667318}`
- monotone_ok=`False`
- monotone_failures=`['gap(2)=0.001250 (need ≤ -0.01)', 'gap(3)=0.000417 not ≤ gap(2)-0.005=-0.003750', 'gap(4)=0.000417 not ≤ gap(3)-0.005=-0.004583']`
